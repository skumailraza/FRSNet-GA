...
parser.add_argument('--model', type=str, default='GANet_ms', help="model to train")
...
def load_data(leftname, rightname, c_height, c_width):
    ...
    return temp_data, dim, s_fac


def test(leftname, rightname, savename):
    #  count=0

    data, dim, s_fac = load_data(leftname, rightname, opt.crop_height, opt.crop_width)
